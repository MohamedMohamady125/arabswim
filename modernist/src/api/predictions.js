...
export const getPredictionExclusions = (id) => api.get(`/predictions/${id}/excluded/`)
export const addPredictionExclusion = (id, data) => api.post(`/predictions/${id}/excluded/`, data)
export const removePredictionExclusion = (id, exclusionId) => api.delete(`/predictions/${id}/excluded/${exclusionId}/`)
