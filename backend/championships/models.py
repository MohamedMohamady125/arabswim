...
class ProgramItem(models.Model):
    ...
    is_auto = models.BooleanField(
        default=False,
        help_text='Generated by the importer from the source file (vs. entered '
                  'by an admin). Auto lines are wiped and rebuilt on re-import; '
                  'admin-entered lines are never touched.')
