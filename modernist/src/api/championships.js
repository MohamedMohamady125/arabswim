...
export const swapNames = (id) => api.post(`/championships/${id}/swap-names/`)
export const uploadBulletin = (id, formData) => api.post(`/championships/${id}/upload-bulletin/`, formData, { timeout: 120000 })
export const quickImport = (id, formData) => api.post(`/championships/${id}/quick-import/`, formData, { timeout: 120000 })
